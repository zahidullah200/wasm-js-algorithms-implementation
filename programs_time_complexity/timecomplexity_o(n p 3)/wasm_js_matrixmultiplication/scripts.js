...
async function testTimeComplexityWASM() {
  ...
  try {
    ...
    const timeInfo = `<div class="time-info">Execution Time: <strong>${executionTime} milliseconds</strong></div>`;
...
function displayResult(time, result, elementId, title) {
  ...
  resultElement.innerHTML = `
        ...
        <div class="time-info">Execution Time: <strong>${time.toFixed(
          2
        )} milliseconds</strong></div>
        <p>Result Matrix:</p>
